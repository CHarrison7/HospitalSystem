package com.ehealth.billingservice.utils;
...
public class UserContext {
    ...
    public static final String PAT_ID         = "tmx-pat-id";

    private static final ThreadLocal<String> correlationId= new ThreadLocal<String>();
    private static final ThreadLocal<String> authToken= new ThreadLocal<String>();
    private static final ThreadLocal<String> userId = new ThreadLocal<String>();
    private static final ThreadLocal<Long> patId = new ThreadLocal<Long>();
    ...
    public static Long getPatId() { return patId.get(); }
    public static void setPatId(Long aPat) {patId.set(aPat);}
